<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchUsers.aspx.cs" Inherits="USoft.Modules.Main.SearchUsers" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Status"></asp:Label></td>
                            <td class="T19">
                    <uc2:ctrlIsActive id="CtrlIsActive" runat="server">
                    </uc2:ctrlIsActive>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="T19">
                                <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="ui-button ui-state-default" OnClick="btnSearch_Click"/>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="T19">
                <td>
                    <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" Style="width: 100%" Width="100%" OnRowCommand="gvUser_RowCommand" OnRowEditing="gvUser_RowEditing" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Email" HeaderText="Email">
                                        <HeaderStyle CssClass="hide" /><ControlStyle CssClass="hide" /><FooterStyle CssClass="hide" /><ItemStyle CssClass="hide" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ChangePass" HeaderText="ChangePass">
                                        <HeaderStyle CssClass="hide" /><ControlStyle CssClass="hide" /><FooterStyle CssClass="hide" /><ItemStyle CssClass="hide" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CanSendMail" HeaderText="CandSendMail">
                                        <HeaderStyle CssClass="hide" /><ControlStyle CssClass="hide" /><FooterStyle CssClass="hide" /><ItemStyle CssClass="hide" />
                                    </asp:BoundField>
                                    ...
                                    <asp:CommandField ButtonType="Button" ShowEditButton="True" EditText="Reset Pwd">
                                        <ControlStyle CssClass="ui-button ui-state-default" />
                                        <ItemStyle CssClass="T19" />
                                    </asp:CommandField>
                                </Columns>
