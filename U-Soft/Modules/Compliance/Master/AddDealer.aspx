<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDealer.aspx.cs" Inherits="USoft.Modules.Compliance.Master.AddDealer" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 120px;">Dealer Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtDealerCode" runat="server" CssClass="validate[required]" MaxLength="20" Width="128px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Dealer Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtDealerName" runat="server" CssClass="validate[required]" MaxLength="50" Width="276px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
