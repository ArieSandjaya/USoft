...
<head runat="server">
    ...
    <script language="javascript">$(document).ready(function() {$('#btnProcess').click(function(){window.parent.parent.loadWait();});
...
<body>
    ...
    <div>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 100%">
                    <input id="btnExcell" type="button" value="Export From Excell" style="width: 168px" />
            </tr>
                ...
                <td style="width: 100px" class="ui-widget-content">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 100px">
                                <asp:FileUpload ID="fuExcell" runat="server" Width="483px" /></td>
                        </tr>
                        <tr>
                            <td style="width: 81px">
                            </td>
            ...
            <tr>
                <td style="width: 100px"><input id="btnManual" type="button" value="Manual Input" style="width: 168px" /></td>
            </tr>
