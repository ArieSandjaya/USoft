...
namespace USoft.Modules.b2bMail
{
    public partial class b2bMailRaksa : System.Web.UI.Page
    {
        protected void Page_Init()
        {
            ...
            //{
            //    ClientScript.RegisterStartupScript(GetType(), "Load", "<script type='text/javascript'>window.top.location.href = 'logon.aspx'; </script>");
            //}
            if (!IsPostBack)
            {
        ...
        public void getEmail()
        {
            ...
            if (Session["UserId"].ToString() != "")/////
            {
                ...
                txtCc.Text = strCC;
                //TEST
                //txtSender.Text = "z.alfarisi@ufindo.com";
                //txtReceiver.Text = "z.alfarisi@ufindo.com";
                //txtCc.Text = "z.alfarisi@ufindo.com";
