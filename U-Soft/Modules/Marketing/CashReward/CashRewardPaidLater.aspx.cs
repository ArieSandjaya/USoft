...
{
    public partial class CashRewardPaidLater : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                gvCashRewardPaidLater.PageSize = USoft.Common.Setting.SystemSetting.PagingSize;
        ...
        {
            ucHeaderPage.Text = "Cash Reward Paid Not in Same Period";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (Status == "REQUEST")
            {
                gvCashRewardPaidLater.Enabled = false;
            ...
            {
                gvCashRewardPaidLater.Enabled = true;
        ...
        private void Show(int MinRow, bool NewSearch)
        {
            ...
            GetCashReward.ShowPaidLater(ParameterCollection, gvCashRewardPaidLater, CtrlPager, MinRow, NewSearch);
        }
        private String getStatus_WF() //get status from table Cash_Reward_Header
        {
            List<KeyValuePair<string, object>> ParameterCollection = new List<KeyValuePair<string, object>>();
            ParameterCollection.Add(new KeyValuePair<string, object>("@PERIOD", txtPeriod.Text));
            ParameterCollection.Add(new KeyValuePair<string, object>("@PaidType", 2));
        ...
        {            
            ...
            ParameterCollection.Add(new KeyValuePair<string, object>("@RECIPIENT_NAME", txtRecipientName.Text));
            ParameterCollection.Add(new KeyValuePair<string, object>("@TYPE", 0));
            GetCashReward.PaidLaterConvertXls(ParameterCollection);                       
        }

        protected void gvCashRewardPaidLater_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void gvCashRewardPaidLater_DataBound(object sender, EventArgs e)
        {
        ...
        private void InsertToCRHeader()
        {
            ...
            string Description = "Total Amount Paid NOT in same Period : " + amountPaid +
                                 "</br> Total Amount Tax not in same Period : " + amountTax +
                                 "</br> Total Amount Net not in same Period : " + amountNet +
