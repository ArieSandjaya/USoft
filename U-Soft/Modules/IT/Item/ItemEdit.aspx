<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemEdit.aspx.cs" Inherits="USoft.Modules.IT.Item.ItemEdit" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 120px;">Item Code</td>
                        ...
                        <tr>
                            ...
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:Label ID="lblItemType" runat="server"></asp:Label></td></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:Label ID="lblBranchName" runat="server"></asp:Label></td></tr>
                        <tr>
