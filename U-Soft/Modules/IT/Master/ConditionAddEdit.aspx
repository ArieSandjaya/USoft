<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConditionAddEdit.aspx.cs" Inherits="USoft.Modules.IT.Master.ConditionAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Condition Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 120px;">Condition Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtConditionCode" runat="server" CssClass="validate[required]" Width="50"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Condition Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtConditionName" runat="server" CssClass="validate[required]" Width="130"></asp:TextBox></td>
                        </tr>
                        <tr>
