...
namespace USoft.Modules.GeneralAffair.Master
{
    public partial class ItemType : USoft.Modules.PageBase
    {
        ...
        {
            GridViewRow rows = gvItemType.Rows[Convert.ToInt32(e.CommandArgument.ToString())];
