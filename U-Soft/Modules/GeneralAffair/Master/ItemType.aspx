<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemType.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.ItemType" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvItemType" runat="server" AutoGenerateColumns="False" Font-Size="8pt" 
                                Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvItemType_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="ItemTypeCode" HeaderText="CODE" >
