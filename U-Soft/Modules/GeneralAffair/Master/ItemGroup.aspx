<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemGroup.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.ItemGroup" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvItemGroup" runat="server" AutoGenerateColumns="False" Font-Size="8pt" 
                                Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvItemGroup_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="ItemGroupCode" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ItemGroupName" HeaderText="NAME" />
