<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemGroupAddEdit.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.ItemGroupAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Item Group Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Item Group Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtItemGroupCode" runat="server" CssClass="validate[required]" Width="60"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Item Group Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtItemGroupName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Item Category <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:DropDownList ID="ddlItemCategory" runat="server" CssClass="validate[required]"></asp:DropDownList></td>
                        </tr>
                        <tr>
