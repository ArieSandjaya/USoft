<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemCategoryAddEdit.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.ItemCategoryAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Item Category Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Item Category Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtItemCategoryCode" runat="server" CssClass="validate[required]" Width="60"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Item Category Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtItemCategoryName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
