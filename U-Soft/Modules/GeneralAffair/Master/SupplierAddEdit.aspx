<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierAddEdit.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.SupplierAddEdit" %>
                ...
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            ...
                            <td class="form_table"><asp:TextBox ID="txtSupplierCode" runat="server" CssClass="validate[required]" Width="50" MaxLength="5"></asp:TextBox></td>
                        </tr>
                        <tr>
