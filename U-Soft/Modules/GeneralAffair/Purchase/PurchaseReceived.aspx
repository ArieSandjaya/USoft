<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReceived.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Purchase.PurchaseReceived" %>
                    ...
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="RECEIVEDID" HeaderText="RECEIVED ID" >
                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ORDERID" HeaderText="ORDER ID" >
                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="RECEIVEDDATE" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="DATE" >
