...
{
    public partial class PurchaseReceived : USoft.Modules.PageBase
    {
        ...
        {
            ucHeaderPage.Text = "Purchase Received";
        ...
        protected void gvPurchase_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hypView.NavigateUrl = "PurchaseReceivedDetail.aspx?validate=" + validate(0) + "&state=view&editID=" + e.Row.Cells[0].Text;
                hypView.CssClass = "MenuLink";
                e.Row.Cells[0].Controls.Add(hypView);

                // Reguler Data
                e.Row.Cells[2].Text = cf.DateFormatDDMMYYYY(e.Row.Cells[2].Text);
                e.Row.Cells[5].Text = cf.DocStatus(e.Row.Cells[5].Text);
            }
        }
        ...
        protected void gvPurchase_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("PurchaseReceivedDetail.aspx?validate=" + validate(0) + "&editID=" + rows.Cells[0].Text + "&state=edit");
            }
        }
        ...
        {
            Response.Redirect("PurchaseReceivedAddEdit.aspx?validate=" + validate(0) + "&state=add");
        }
