<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrder.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Purchase.PurchaseOrder" %>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvPurchase" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ORDERDATE" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="DATE" >
