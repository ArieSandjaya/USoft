...
{
    public partial class PurchaseOrder : USoft.Modules.PageBase
    {
        ...
        {
            ucHeaderPage.Text = "Purchase Order";
        ...
        protected void gvPurchase_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hypView.NavigateUrl = "PurchaseOrderDetail.aspx?validate=" + validate(0) + "&state=view&editID=" + e.Row.Cells[0].Text;
        ...
        protected void gvPurchase_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("PurchaseOrderDetail.aspx?validate=" + validate(0) + "&editID=" + rows.Cells[0].Text + "&state=edit");
            }
        }
        ...
        {
            Response.Redirect("PurchaseOrderAddEdit.aspx?validate=" + validate(0) + "&state=add");
        }
