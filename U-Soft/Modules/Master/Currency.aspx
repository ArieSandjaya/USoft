<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Currency.aspx.cs" Inherits="USoft.Modules.Master.Currency" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvCurrency" runat="server" AutoGenerateColumns="False" Font-Size="8pt" 
                                Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvCurrency_RowCommand" >
                                <Columns>
                                    <asp:BoundField DataField="CurrencyCode" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CurrencyName" HeaderText="NAME" />
