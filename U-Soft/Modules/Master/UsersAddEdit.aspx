<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersAddEdit.aspx.cs" Inherits="USoft.Modules.Master.UsersAddEdit" %>
...
<%@ Register Src="~/Controls/ctrlIsActive.ascx" TagName="ctrlIsAllBranch" TagPrefix="uc3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Users Add Edit</title>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td class="ui-widget-content">
                        <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                            <tr>
                                <td class="form_table_title" style="width: 160px;">User ID <span class="reqMark">*</span></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table"><asp:TextBox ID="txtUserId" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="form_table_title">User Name <span class="reqMark">*</span></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table"><asp:TextBox ID="txtUserName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="form_table_title" style="height: 22px">E-Mail <span class="reqMark">*</span></td>
                                <td class="form_table_sepp" style="height: 22px">:</td>
                                <td class="form_table" style="height: 22px"><asp:TextBox ID="txtEmail" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="form_table_title">Password <asp:Label ID="lblMarkPassword" runat="server" CssClass="reqMark" Text="*"></asp:Label></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table"><asp:TextBox ID="txtPassword" TextMode="Password" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="form_table_title">Confirm Password <asp:Label ID="lblMarkConfirm" runat="server" CssClass="reqMark" Text="*"></asp:Label></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table"><asp:TextBox ID="txtConfirm" TextMode="Password" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="form_table_title">All Branch Access <span class="reqMark">*</span></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table">
                                    <uc3:ctrlIsAllBranch ID="ucIsAllBranch" runat="server" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="form_table_title">Can Change Password <span class="reqMark">*</span></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table">
                                    <asp:DropDownList ID="ddlChangePass" runat="server" CssClass="validate[required]">
                            ...
                            <tr>
                                <td class="form_table_title">Can Send E-Mail <span class="reqMark">*</span></td>
                                <td class="form_table_sepp">:</td>
                                <td class="form_table">
                                    <asp:DropDownList ID="ddlSendEmail" runat="server" CssClass="validate[required]">
                                        <asp:ListItem Value="" Selected="True">- Select One -</asp:ListItem>
                                        <asp:ListItem Value="Y">Yes</asp:ListItem>
                                        <asp:ListItem Value="N">No</asp:ListItem>
                                    </asp:DropDownList>
                ...
                <tr id="trMenu" runat="server">
                    <td class="ui-widget-content">
                        ...
                        <div style="text-align:center; height:30px;">Set Privilege Menu By : Privilege <span class="reqMark">*</span> <asp:DropDownList ID="ddlPrivilegeMenu" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPrivilegeMenu_SelectedIndexChanged" CssClass="validate[required]" /> - User <asp:DropDownList ID="ddlUserMenu" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlUserMenu_SelectedIndexChanged" /></div>
