<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departement.aspx.cs" Inherits="USoft.Modules.Master.Departement" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvDepartement" runat="server" AutoGenerateColumns="False"  
                                 Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvDepartement_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="DEPARTEMENTCODE" HeaderText="CODE" >
