<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Measurement.aspx.cs" Inherits="USoft.Modules.Master.Measurement" %>
             ...
             <tr class="T19">
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvMeasurement" runat="server" AutoGenerateColumns="False"
                                 Font-Size="8pt" Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvMeasurement_RowCommand"  >
                                <Columns>
                                    <asp:BoundField DataField="MeasurementCode" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="MeasurementName" HeaderText="NAME" />
