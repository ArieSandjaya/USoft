<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Condition.aspx.cs" Inherits="USoft.Modules.IT.Master.Condition" %>
             ...
             <tr class="T19">
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvCondition" runat="server" AutoGenerateColumns="False"
                                 Font-Size="8pt" Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvCondition_RowCommand" 
                                 >
                                <Columns>
                                    <asp:BoundField DataField="ConditionCode" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ConditionName" HeaderText="CONDITION NAME" />
