<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemTypeAddEdit.aspx.cs" Inherits="USoft.Modules.IT.Master.ProblemTypeAddEdit" %>
...
<head id="Head1" runat="server">
    <title>IT Problem Type Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Problem Type Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtProblemTypeCode" runat="server" CssClass="validate[required]" Width="50"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Problem Type Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtProblemTypeName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
