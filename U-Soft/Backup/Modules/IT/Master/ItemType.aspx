<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemType.aspx.cs" Inherits="USoft.Modules.IT.Master.ItemType" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvITItemType" runat="server" AutoGenerateColumns="False"
                                 Font-Size="8pt" Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvITItemType_RowCommand" >
                                <Columns>
                                    <asp:BoundField DataField="ItemTypeCode" HeaderText="ITEM TYPE CODE" >
