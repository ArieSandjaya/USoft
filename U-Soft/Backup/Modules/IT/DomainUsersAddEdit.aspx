<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DomainUsersAddEdit.aspx.cs" Inherits="USoft.Modules.IT.DomainUsersAddEdit" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 120px;">Branch Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtBranchCode" runat="server" CssClass="validate[required]" Width="35" MaxLength="3"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Branch Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtBranchName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">IP Address <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtIPAddress" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Username <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtUsername" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Password <asp:Label ID="lblPasswordMark" CssClass="reqMark" Text="*" runat="server"></asp:Label></td>
                            <td class="form_table_sepp">:</td>
