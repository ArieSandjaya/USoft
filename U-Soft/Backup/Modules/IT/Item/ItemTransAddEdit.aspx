<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemTransAddEdit.aspx.cs" Inherits="USoft.Modules.IT.Item.ItemTransAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Item-Trans Add Edit</title>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(function() { $("#txtTransDate").datepicker({dateFormat: "yy-mm-dd"}); });
        });
                ...
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            ...
                            <td class="form_table"><asp:Label id="lblItemTransCode" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Origin</td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:DropDownList ID="ddlBranchFrom" runat="server"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Destination</td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:DropDownList ID="ddlBranchTo" runat="server"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Transfer Date <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtTransDate" runat="server" CssClass="validate[required] text-input datepicker" onChange="getDate(this.value);" Width="94px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
