<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDepartment.aspx.cs" Inherits="USoft.Modules.Compliance.Master.EditDepartment" %>
                ...
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            ...
                            <td class="form_table"><asp:TextBox ID="txtDeptCode1" runat="server" CssClass="validate[required]" MaxLength="5" Width="60px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Departement Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtDeptName1" runat="server" CssClass="validate[required]" MaxLength="50"></asp:TextBox></td>
                        </tr>
                        <tr>
