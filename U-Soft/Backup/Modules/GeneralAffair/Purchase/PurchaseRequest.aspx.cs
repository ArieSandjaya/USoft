...
{
    public partial class PurchaseRequest : USoft.Modules.PageBase
    {
        ...
        {
            ucHeaderPage.Text = "Purchase Request";
        ...
        private void ShowData()
        {
            ...
            if (!enUI.IsAllBranch)
            {
                WhereBy += cf.SqlAndOr(WhereBy, true) + " a.BranchId = " + enUI.BranchId.ToString();
                WhereBy += cf.SqlAndOr(WhereBy, true) + " a.DepartementCode = '" + enUI.DepartementCode + "'";
            }
        ...
        protected void gvPurchase_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hypView.NavigateUrl = "PurchaseRequestDetail.aspx?validate=" + validate(0) + "&state=view&editID=" + e.Row.Cells[0].Text;
        ...
        protected void gvPurchase_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("PurchaseRequestDetail.aspx?validate=" + validate(0) + "&editID=" + rows.Cells[0].Text + "&state=edit");
            }
        }
        ...
        {
            Response.Redirect("PurchaseRequestAddEdit.aspx?validate=" + validate(0) + "&state=add");
        }
