...
{
    public partial class ItemCategory : USoft.Modules.PageBase
    {
        ...
        {
            ucHeaderPage.Text = "Item Category";
        ...
        private void ShowData()
        {
            ...
            ds = da.getItemCategory(ref info);
        ...
        {
            GridViewRow rows = gvItemCategory.Rows[Convert.ToInt32(e.CommandArgument.ToString())];

            if (e.CommandName == "Edit")
            {
                Response.Redirect("ItemCategoryAddEdit.aspx?validate=" + validate(0) + "&editID=" + rows.Cells[0].Text + "&state=edit");
            }
        }
        ...
        {
            Response.Redirect("ItemCategoryAddEdit.aspx?validate=" + validate(0) + "&state=add");
        }
    }
}
