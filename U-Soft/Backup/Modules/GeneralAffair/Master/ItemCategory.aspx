<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemCategory.aspx.cs" Inherits="USoft.Modules.GeneralAffair.Master.ItemCategory" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvItemCategory" runat="server" AutoGenerateColumns="False" Font-Size="8pt" 
                                Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvItemCategory_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="ItemCategoryCode" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ItemCategoryName" HeaderText="NAME" />
