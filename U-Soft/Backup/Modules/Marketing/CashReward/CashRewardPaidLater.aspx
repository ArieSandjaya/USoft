<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashRewardPaidLater.aspx.cs" Inherits="USoft.Modules.Marketing.CashReward.CashRewardPaidLater" %>
...
<head runat="server">
    <title>Cash Reward Paid NOT in same Period</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <asp:UpdatePanel ID="updPanel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvCashRewardPaidLater" runat="server" AutoGenerateColumns="False" PageSize="50" Font-Size="8pt" ShowFooter="True" Style="width: 100%" OnDataBound="gvCashRewardPaidLater_DataBound" OnRowDataBound="gvCashRewardPaidLater_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="admin_fee" HeaderText="Admin Fee" />
                                    ...
                                    <asp:TemplateField HeaderText="NPWP">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("npwp") %>'></asp:TextBox></EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Later Paid">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkLater" runat="server" Checked='<%# (Eval("paid_not_in_same_period").ToString()=="Y")?Convert.ToBoolean(1):Convert.ToBoolean(0) %>' Enabled="false"/></ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
