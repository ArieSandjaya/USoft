<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankGroupAddEdit.aspx.cs" Inherits="USoft.Modules.Master.BankGroupAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Bank Group Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Bank Group Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtBankGroupCode" runat="server" CssClass="validate[required]" Width="35" MaxLength="3"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">BankGroup Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtBankGroupName" runat="server" CssClass="validate[required]" Width="200"></asp:TextBox></td>
                        </tr>
                        <tr>
