<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrencyAddEdit.aspx.cs" Inherits="USoft.Modules.Master.CurrencyAddEdit" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 120px;">Currency Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtCurrencyCode" runat="server" CssClass="validate[required]" Width="60"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Currency Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtCurrencyName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
