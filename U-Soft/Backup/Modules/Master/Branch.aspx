<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Branch.aspx.cs" Inherits="USoft.Modules.Master.Branch" %>
                    ...
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvBranch" runat="server" AutoGenerateColumns="False"
                                 Font-Size="8pt" Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvBranch_RowCommand" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BranchParent" HeaderText="BRANCH PARENT" />
