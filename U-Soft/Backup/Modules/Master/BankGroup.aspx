<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankGroup.aspx.cs" Inherits="USoft.Modules.Master.BankGroup" %>
             ...
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvBankGroup" runat="server" AutoGenerateColumns="False"  
                                 Style="width: 100%" EmptyDataText="No Data Available" OnRowCommand="gvBankGroup_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="BANKGROUPCODE" HeaderText="CODE" >
                                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="BANKGROUPNAME" HeaderText="BANK GROUP NAME" />
