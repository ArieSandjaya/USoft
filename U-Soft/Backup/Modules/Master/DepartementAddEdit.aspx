<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartementAddEdit.aspx.cs" Inherits="USoft.Modules.Master.DepartementAddEdit" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Departement Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtDepartementCode" runat="server" CssClass="validate[required]" Width="25" MaxLength="2"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Departement Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtDepartementName" runat="server" CssClass="validate[required]" Width="200"></asp:TextBox></td>
                        </tr>
                        <tr>
