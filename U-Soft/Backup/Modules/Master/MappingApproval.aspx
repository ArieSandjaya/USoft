<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MappingApproval.aspx.cs" Inherits="USoft.Modules.Master.MappingApproval" %>
            ...
            <tr>
                <td class="ui-widget-content">
                    ...
                    <div class="form_table_btn">
                        ...
                        <asp:ImageButton ID="imbAdd" runat="server" ImageUrl="~/Images/BtnAdd.png" OnClick="imbAdd_Click" />
                    </div>
                </td>
             </tr>
             <tr>
                <td>
                    <asp:UpdatePanel ID="pnlDataTable" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvMappingApproval" runat="server" AutoGenerateColumns="False"
                                 Font-Size="8pt" Style="width: 100%" EmptyDataText="No Data Available" 
                                 OnRowDataBound="gvMappingApproval_RowDataBound" OnRowCommand="gvMappingApproval_RowCommand" OnRowDeleting="gvMappingApproval_RowDeleting">
                                <Columns>
                                    <asp:BoundField DataField="APPROVALID">
                                    ...
                                    <asp:BoundField DataField="DEPARTEMENTNAME" HeaderText="DEPARTEMENT" />
                                    <asp:BoundField DataField="PARENTNAME" HeaderText="PARENT" />
                                    <asp:BoundField DataField="USERNAMEAPPROVAL" HeaderText="USER" />
                                    <asp:BoundField DataField="ISBRANCH" HeaderText="FOR BRANCH" >
                                        <ItemStyle Width="80px" HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="STATE" HeaderText="STATE" >
                                        <ItemStyle Width="50px" HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="STATEDESCRIPTION" HeaderText="STATE DESC" />
