<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeasurementAddEdit.aspx.cs" Inherits="USoft.Modules.Master.MeasurementAddEdit" %>
...
<head id="Head1" runat="server">
    <title>Measurement Add Edit</title>
            ...
            <tr>
                <td class="ui-widget-content">
                    <table style="width: 100%" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td class="form_table_title" style="width: 140px;">Measurement Code <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtMeasurementCode" runat="server" CssClass="validate[required]" Width="60"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="form_table_title">Measurement Name <span class="reqMark">*</span></td>
                            <td class="form_table_sepp">:</td>
                            <td class="form_table"><asp:TextBox ID="txtMeasurementName" runat="server" CssClass="validate[required]"></asp:TextBox></td>
                        </tr>
                        <tr>
