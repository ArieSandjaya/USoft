<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPage2.aspx.cs" Inherits="USoft.Insurance.Tokio.PrintPage2" %>
...
<asp:GridView ID="gdView" runat="server" AutoGenerateColumns="False" EnableTheming="False" BorderStyle="None" GridLines="None" OnRowDataBound="gdView_RowDataBound">
            <Columns>
