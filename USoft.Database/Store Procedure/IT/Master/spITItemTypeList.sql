IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spITItemTypeList]') AND type in (N'P', N'PC'))
BEGIN
	PRINT 'DROP PROCEDURE spITItemTypeList'
	DROP PROCEDURE [dbo].[spITItemTypeList]
END
GO

PRINT 'CREATE PROCEDURE spITItemTypeList'
GO

/*---------------------------------------------------------------------------
**	SP Name			: spITItemTypeList
**	Running On		: 192.168.1.254
**	Database		: U-Soft
**	Created By		: z.alfarisi
**	Created Date	: 2013-07-03
**	Description		: SP untuk show data Item Type
**
**	Change Log		:
**	No.		Date	Name		Description
---------------------------------------------------------------------------*/
CREATE PROCEDURE spITItemTypeList		
