IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spITProblemTypeList]') AND type in (N'P', N'PC'))
BEGIN
	PRINT 'DROP PROCEDURE spITProblemTypeList'
	DROP PROCEDURE [dbo].[spITProblemTypeList]
END
GO

PRINT 'CREATE PROCEDURE spITProblemTypeList'
GO

/*---------------------------------------------------------------------------
**	SP Name			: spITProblemTypeList
**	Running On		: 192.168.1.254
**	Database		: U-Soft
**	Created By		: z.alfarisi
**	Created Date	: 2013-07-03
**	Description		: SP untuk show data Problem Type
**
**	Change Log		:
**	No.		Date	Name		Description
---------------------------------------------------------------------------*/
CREATE PROCEDURE spITProblemTypeList		
