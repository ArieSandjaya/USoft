IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spGAItemGroupList]') AND type in (N'P', N'PC'))
BEGIN
	PRINT 'DROP PROCEDURE spGAItemGroupList'
	DROP PROCEDURE [dbo].[spGAItemGroupList]
END
GO

PRINT 'CREATE PROCEDURE spGAItemGroupList'
GO

/*---------------------------------------------------------------------------
**	SP Name			: spGAItemGroupList
...
---------------------------------------------------------------------------*/
CREATE PROCEDURE spGAItemGroupList		
