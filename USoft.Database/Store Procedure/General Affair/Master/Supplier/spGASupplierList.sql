IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spGASupplierList]') AND type in (N'P', N'PC'))
BEGIN
	PRINT 'DROP PROCEDURE spGASupplierList'
	DROP PROCEDURE [dbo].[spGASupplierList]
END
GO

PRINT 'CREATE PROCEDURE spGASupplierList'
GO

/*---------------------------------------------------------------------------
**	SP Name			: spGASupplierList
...
---------------------------------------------------------------------------*/
CREATE PROCEDURE spGASupplierList		
